...
- SSTV contains link to https://rentry.org/bad-radio, informs the viewer to download a file called flag.mp4.zst
- decompress file with zstd command, output decompressed mp4
- mp4 contains flag scattered throughout the video

Flag: slashroot7{R4di0_h4s_B33n_T0uhoU_h1JAck3D_w_4pPPl3_Z0MG}

Notes:
- only upload 09-06-2023_‏‎20.28.30.wav, AND NOTHING ELSE
